          ...
          <div className="grid md:grid-cols-3 gap-8 max-w-6xl mx-auto">
            ...
            <div className={`bg-white rounded-2xl shadow-lg p-8 `}>
              ...
              <button
                ...
                disabled={
                  isCurrentTier("FREE") ||
                  (!currentSubscription?.tier && isAuthenticated)
                }
            ...
            {/* Basic Plan */}
            <div
              className={`bg-white rounded-2xl shadow-lg p-8 ${isCurrentTier("BASIC") ? "ring-2 ring-indigo-500" : ""}`}
            >
              ...
              <ul className="space-y-4 mb-8">
                ...
                <li className="flex items-start">
                  ...
                  <span className="text-gray-700">
                    Unlimited profiles per deletion
                  </span>
                </li>
                <li className="flex items-start">
                  <svg
            ...
            {/* Pro Plan */}
            <div
              className={`bg-white rounded-2xl shadow-lg p-8 border-2 border-indigo-500 relative ${isCurrentTier("PRO") ? "ring-2 ring-indigo-500" : ""}`}
            >
              {!isCurrentTier("PRO") && (
