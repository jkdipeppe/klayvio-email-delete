  ...
  return (
    <>
      <Head>
        ...
        <meta name="description" content="Privacy Policy for Klaviyo Spam Profile Cleaner" />
            ...
            <div className="prose prose-indigo max-w-none">
              <section className="mb-8">
                ...
                <p className="text-gray-700 leading-relaxed mb-4">
                  Klaviyo Spam Profile Cleaner ("we", "our", or "us") is committed to protecting your privacy. This Privacy Policy explains how we collect, use, disclose, and safeguard your information when you use our service to clean spam profiles from your Klaviyo account.
                </p>
              </section>
              ...
              <section className="mb-8">
                ...
                <ul className="list-disc list-inside text-gray-700 mb-4 space-y-2">
                  ...
                  <li>Scheduled cleanup preferences</li>
              ...
              <section className="mb-8">
                ...
                <ul className="list-disc list-inside text-gray-700 mb-4 space-y-2">
                  <li>Provide and maintain our spam profile cleaning service</li>
                  <li>Execute cleanup operations according to your configured rules</li>
              ...
              <section className="mb-8">
                ...
                <ul className="list-disc list-inside text-gray-700 mb-4 space-y-2">
                  <li><strong>Klaviyo API:</strong> We use your OAuth tokens to interact with Klaviyo's API on your behalf, as authorized by you</li>
                  <li><strong>Payment Processing:</strong> We use Stripe to process payments. Stripe's use of your information is governed by their privacy policy</li>
                  <li><strong>Service Providers:</strong> We may use third-party service providers (e.g., hosting, database) who are contractually obligated to protect your information</li>
              ...
              <section className="mb-8">
                ...
                <p className="text-gray-700 leading-relaxed mb-4">
                  We retain your information for as long as necessary to provide our services and comply with legal obligations. When you disconnect your account, we will delete your OAuth tokens and may retain anonymized usage data for analytical purposes.
                </p>
              </section>
